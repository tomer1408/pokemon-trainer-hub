...
// ISO 3166-1 alpha-2 codes, so a real flag glyph can be derived per country
// (see countryFlag() below) instead of hardcoding 149 emoji by hand.
export const COUNTRIES: Country[] = [
  ...
  { name: 'Sri Lanka', code: 'LK' }, { name: 'Sudan', code: 'SD' }, { name: 'Sweden', code: 'SE' },
...
// Converts a 2-letter ISO code into its flag emoji by mapping each letter to
// its Regional Indicator Symbol codepoint (U+1F1E6 = 'A') — real Unicode
// flag glyphs, not an image asset or external request.
